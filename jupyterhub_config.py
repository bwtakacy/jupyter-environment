...
c.JupyterHub.admin_users = {'bwtkacy'}
...
#c.JupyterHub.data_files_path = '/Users/oonishitk/.pyenv/versions/3.5.2/share/jupyter/hub'
...
c.Authenticator.whitelist = {'bwtakacy','user01'}
